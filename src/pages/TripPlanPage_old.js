              ...
              <>
                <button
                  ...
                  style={{
                    padding: '8px 16px',
                    borderRadius: 6,
                    background: aiLoading ? 'rgba(0, 0, 0, 0.1)' : saveSuccess ? '#10b981' : '#000000',
                    border: 'none',
                    color: '#fff',
                    fontSize: 13,
                    fontWeight: 600,
                ...
                <button
                  ...
                  style={{
                    padding: '8px 16px',
                    borderRadius: 6,
                    background: aiLoading ? 'rgba(0, 0, 0, 0.1)' : '#000000',
                    border: 'none',
                    color: '#fff',
                    fontSize: 13,
                    fontWeight: 600,
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              padding: '12px 16px',
              borderRadius: 8,
              background: saveSuccess ? '#10b981' : '#000000',
              border: 'none',
              color: '#fff',
              fontSize: 14,
              fontWeight: 600,
              cursor: 'pointer',
              transition: 'all 0.2s',
              boxShadow: saveSuccess ? '0 2px 8px rgba(16, 185, 129, 0.3)' : '0 2px 8px rgba(0, 0, 0, 0.3)'
            }}
          >
